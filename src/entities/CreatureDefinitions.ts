...
//  char  type               color          speed  description
  ...
  ['d',  'wolf',            'gray',           9,   'A wild, four-legged predator with sharp teeth.'],
  ['d',  'dire wolf',       'cyan',           9,   'A larger, more aggressive version of a wolf.'],
  ...
  ['h',  'human',           'yellow',        10,   'A common inhabitant of the dungeon.'],
